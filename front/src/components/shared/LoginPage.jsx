...
import LogoWhite from "/Assets/LogoWhite.svg"; // Import the logo
import Logo from "/Assets/Logo.svg"; // Import the logo
import EmailIcon from "/Assets/email.svg"; // Import the email icon
import PasswordIcon from "/Assets/password.svg"; // Import the password icon
import EyeCloseIcon from "/Assets/eye-closed.svg"; // Import the eye-close icon
...
function LoginPage () {
  ...
  return (
    <div className="flex w-full h-screen cursor-default">
      ...
      >
        <img src={LogoWhite} alt="Logo" className="mb-4" /> {/* Replace text with logo */}
      ...
      <div className="w-1/2 bg-white flex items-center justify-center">
        <div className="w-full max-w-md bg-white rounded-lg p-12">
          <img src={Logo} alt="Logo" style={{ marginLeft: 0 }} /> {/* Add logo */}
          <h2 className="text-3xl font-base text-indigo-900 mb-6" style={{ textAlign: 'left' }}>
          ...
          <form className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative mt-1">
                <img src={EmailIcon} alt="Email Icon" className="absolute inset-y-0 left-3 w-5 h-5 my-auto" />
                <input
                  type="email"
                  id="email"
            ...
            <div className="relative">
              ...
              <div className="relative mt-1">
                <img src={PasswordIcon} alt="Password Icon" className="absolute inset-y-0 left-3 w-5 h-5 my-auto" />
                <input
            ...
            <div className="text-left">
              <a href="#" className="text-l text-indigo-600 hover:underline cursor-pointer">
